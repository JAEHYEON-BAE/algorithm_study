...
int main() {
  ...
  for (int i=0;i<n;++i) {
    planets[i].id=i;
    fastio::read(planets[i].x);
    fastio::read(planets[i].y);
    fastio::read(planets[i].z);
  }
  ...
  for (int i=0;i<n-1;++i) {
    edges.push_back(Edge(planets[i].id, planets[i+1].id, planets[i+1].x-planets[i].x));
  }
  ...
  for (int i=0;i<n-1;++i) {
    edges.push_back(Edge(planets[i].id, planets[i+1].id, planets[i+1].y-planets[i].y));
  }
  ...
  for (int i=0;i<n-1;++i) {
    edges.push_back(Edge(planets[i].id, planets[i+1].id, planets[i+1].z-planets[i].z));
  }
